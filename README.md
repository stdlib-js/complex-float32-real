...
```javascript
import real from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-real@v0.1.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-real/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/complex-float32-real/actions/workflows/test.yml?query=branch:v0.1.2
